...
export default function Register() {
    ...
    const fullText = 'Create your Tasko account!';
                    ...
                    >
                        ...
                        <form className="flex w-full flex-col gap-6" onSubmit={submit}>
                            <div className="grid gap-6 rounded-xl border border-[#036BFF] bg-[#0C0C18]/100 px-4 py-6 shadow-[0_0_6px_#036BFF33]">
                                <div className="text-center">
                                    <p className="text-xs text-white/80">
                                        Enter your <strong className="text-base text-[#036BFF]">details</strong> to create your account and start
                                        thriving.
                                    </p>
                                </div>
                            ...
                            <div className="text-center text-sm text-white/80">
                                ...
                                <TextLink href={route('login')} className="text-[#036BFF] hover:underline" tabIndex={6}>
                                    Log in
                                </TextLink>
                            </div>
                        </form>
